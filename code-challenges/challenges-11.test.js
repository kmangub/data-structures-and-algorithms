...
const toLastNames = people => {
  ...
  people.map(data => {
    fullNameArray.push(data.firstName + ' ' + data.lastName);
  });
...
const validateEmail = (email) => {
  // Solution code here...
  let emailValidator = /^\w+.\w+@\w+.?(com|net|org)$/;
...
// Collaborated with Nick Dorkins, Jae Choi, and Michael Mandell
