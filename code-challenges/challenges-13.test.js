...
const firstLetters = (arr) => {
  // Solution code here...
  let firstLetterArr = arr.map(str => str.charAt(0));
...
const findHappiness = (arr) => {
  // Solution code here...
  let happy = arr.filter(smile => smile.includes(':)'));
  return happy;
};
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let phoneNumbers = arr.map(phone => phone.substring(1, 4) + phone.substring(6, 9) + phone.substring(10, 14));
  return phoneNumbers;
};
